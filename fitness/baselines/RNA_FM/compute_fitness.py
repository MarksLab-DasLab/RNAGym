...
def compute_scores_masked(model, alphabet, batch_converter, reference, args, batch_size=64): # scoring with masked-marginals strategy
...
def compute_scores_wt(model, alphabet, batch_converter, reference, args):
    ...
    for index, row in reference.iterrows():
        ...
        try:
            ...
            valid_mask = mut_df['mutant'].str.match(r'^([AUCG][0-9]+[AUCG])(,[AUCG][0-9]+[AUCG])*$')
