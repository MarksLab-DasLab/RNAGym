...
RNA3DB_CMSCANS_DIR = Config3D.RNA3DB_DIR / "cmscans"
...
RNA3DB_DIR = Config3D.RNA3DB_DIR
...
AF3 = Baseline(
    ...
    training_cutoff="2021-09-30",  # https://doi.org/10.1038/s41586-024-07487-w
)

NUFOLD = Baseline(
    name="nu",
    environment="nufold",
    out_pdb="output/{name_lower}/{name_lower}_rank_1.pdb",
    afa_file="input/{name_lower}/{name_lower}.a3m",
    mul_afa_file=None,
    training_cutoff="2022-02-28",  # https://doi.org/10.1038/s41467-025-56261-7
)
...
RF2NA = Baseline(
    ...
    training_cutoff="2020-04-30",  # https://doi.org/10.1038/s41592-023-02086-5
)
...
RHOFOLD = Baseline(
    ...
    afa_file="sequence.a3m",
    mul_afa_file=None,
    training_cutoff="2022-04-13",  # https://doi.org/10.1038/s41592-024-02487-0
)
...
TRRNA = Baseline(
    ...
    afa_file="sequence.a3m",
    mul_afa_file=None,
    training_cutoff="2022-01-01",  # https://doi.org/10.1038/s41467-023-42528-4
)
